...
const CAT_IMAGES: Record<string, string> = {
  'power-charging':              'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?auto=format&fit=crop&w=800&q=80',
  ...
  'surge-extensions':            'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80',
  'power-stations-generators':   'https://images.unsplash.com/photo-1610563166150-b34df4f3bcd6?auto=format&fit=crop&w=800&q=80',

  'audio-entertainment':         'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=800&q=80',
  ...
  'streaming-devices':           'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80',

  'computing-accessories':       'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=800&q=80',
  'smartphones-tablets':         'https://fdn2.gsmarena.com/vv/bigpic/apple-iphone-15.jpg',
  ...
  'home-appliances-comfort':     'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?auto=format&fit=crop&w=800&q=80',
  ...
  'networking-connectivity':     'https://images.unsplash.com/photo-1606904825846-647eb07f5be2?auto=format&fit=crop&w=800&q=80',
  ...
  'wearables-smart-devices':     'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=800&q=80',
  ...
  'security-surveillance':       'https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=800&q=80',
  'cctv-cameras':                'https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=800&q=80',
  'smart-locks':                 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80',

  'drones-accessories':          'https://images.unsplash.com/photo-1473968512647-3e447244af8f?auto=format&fit=crop&w=800&q=80',
  ...
  'content-creation-kits':       'https://images.unsplash.com/photo-1516724562728-afc824a36e84?auto=format&fit=crop&w=800&q=80',
...
async function run() {
  ...
  for (const [slug, image] of Object.entries(CAT_IMAGES)) {
    const result = await db.update(categories).set({ image, updatedAt: new Date() }).where(eq(categories.slug, slug))
    updated++
  }
