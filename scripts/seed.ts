...
const PRODUCTS: (typeof schema.products.$inferInsert)[] = [
  {
    ...
    price: '85000', comparePrice: '105000', categoryId: 'cat-1',
  ...
  },
  {
    ...
    price: '185000', comparePrice: '220000', categoryId: 'cat-2',
  ...
  },
  {
    ...
    price: '45000', comparePrice: '55000', categoryId: 'cat-5',
  ...
  },
  {
    ...
    price: '32000', comparePrice: '38000', categoryId: 'cat-6',
  ...
  },
  {
    ...
    price: '15000', comparePrice: '20000', categoryId: 'cat-4',
  ...
  },
  {
    ...
    price: '48000', comparePrice: '58000', categoryId: 'cat-5',
...
const RAFFLES: (typeof schema.raffles.$inferInsert)[] = [
  {
    ...
    description: 'Enter for a chance to win our flagship headphones + accessories worth ₦150,000. Only 500 tickets available.',
    prize: 'SonicPro X1 + Full Accessory Bundle',
    prizeValue: '150000', ticketPrice: '2000', maxTickets: 500, soldTickets: 342,
    status: 'active',
  ...
  },
  {
    ...
    prizeValue: '400000', ticketPrice: '5000', maxTickets: 200, soldTickets: 187,
    status: 'active',
  ...
  },
  {
    ...
    description: 'The premium smartwatch that does it all. One lucky winner takes home this ₦220,000 flagship watch.',
    prize: 'VisionWatch Pro 5 (Titanium)',
    prizeValue: '220000', ticketPrice: '3000', maxTickets: 300, soldTickets: 89,
    status: 'upcoming',
...
const SETTINGS: { key: string; value: string }[] = [
  { key: 'storeName', value: 'Val Gadgets' },
  { key: 'storeEmail', value: 'support@valgadgets.com' },
  { key: 'storePhone', value: '+234 703 857 2046' },
  { key: 'storeDescription', value: 'Your number 1 gadget plug. Solution to every gadget need — with nationwide delivery across Nigeria.' },
  { key: 'maintenanceMode', value: 'false' },
  { key: 'freeShippingThreshold', value: '50000' },
  { key: 'codEnabled', value: 'true' },
  { key: 'paystackEnabled', value: 'true' },
  { key: 'btcEnabled', value: 'true' },
  { key: 'ethEnabled', value: 'true' },
  { key: 'usdtTrc20Enabled', value: 'true' },
  { key: 'usdtErc20Enabled', value: 'true' },
  { key: 'emailOrderConfirm', value: 'true' },
  { key: 'emailShippingUpdate', value: 'true' },
  { key: 'emailPromo', value: 'false' },
  { key: 'seoTitle', value: 'Val Gadgets — Your #1 Gadget Plug in Nigeria' },
  { key: 'seoDescription', value: 'Your number 1 gadget plug. Shop phones, laptops, power banks, solar inverters & accessories. Nationwide delivery.' },
  { key: 'seoKeywords', value: 'gadgets Nigeria, buy phones Nigeria, laptops Nigeria, power bank Nigeria, solar inverter Nigeria' },
  { key: 'alertNewOrder', value: 'true' },
  { key: 'alertLowStock', value: 'true' },
...
async function seed() {
  ...
  // Products — upsert to fix prices from USD to NGN
  console.log('\n📦 Upserting products (fixing prices to Naira)...')
  for (const product of PRODUCTS) {
    const { id, ...values } = product
    await db.insert(schema.products).values(product)
      .onConflictDoUpdate({ target: schema.products.id, set: values })
    console.log(`   ✓ ${product.name} → ₦${product.price}`)
  }

  // Raffles — upsert to fix prices
  console.log('\n🎟️  Upserting raffles (fixing prices to Naira)...')
  for (const raffle of RAFFLES) {
    const { id, ...values } = raffle
    await db.insert(schema.raffles).values(raffle)
      .onConflictDoUpdate({ target: schema.raffles.id, set: values })
    console.log(`   ✓ ${raffle.title}`)
  }

  // Affiliate user
  console.log('\n👤 Upserting affiliate user...')
  ...
  await db.insert(schema.users).values({
    ...
    set: { name: AFFILIATE_USER.name, affiliateCode: AFFILIATE_USER.affiliateCode, isVerified: true, updatedAt: new Date() },
  })
  console.log('   ✓ Maya Affiliate (maya@valgadget.com)')
